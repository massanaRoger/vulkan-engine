...
void Engine::Renderer::draw_frame()
{
	...
	uint32_t imageIndex;
	VK_CHECK(vkAcquireNextImageKHR(m_device, m_swapchain, UINT64_MAX, m_imageAvailableSemaphore, VK_NULL_HANDLE, &imageIndex));
...
void Engine::Renderer::create_command_buffer()
{
